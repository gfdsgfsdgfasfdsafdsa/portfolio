...
<template>
	<div class="projects" v-for="(project, i) in projects" :key="i">
		<div class="project" :class="{'order1': project.addClass}">
			<div class="info" :class="{'text-right': project.addClass, 'padding-right': !project.addClass}">
